    ...
    <React.Fragment>
      <div className="footer flex">
        <div className="block flex flex-col">
          ...
          <Link className="noul noulh font s14 color" to="/">
            Cars
          </Link>
          <Link className="noul noulh font s14 color" to="/">
            Flat for Rent
        ...
        <div class="block flex flex-col">
          <span className="title s16 fontb color">Follow Us</span>
          <div className="">
            <a
...
{
  /* <section className="title s16 fontb color">
        Popular Categories
        <ul>
          <li>
            <a className="" rel="" data-aut-id="" href="/cars_c84">
              Cars
            </a>
          </li>
          <li>
            <a
              ...
              rel=""
              data-aut-id=""
              href="/apartments-flats_c1723"
            >
              Flats for rent
            </a>
          </li>
          <li>
            <a className="" rel="" data-aut-id="" href="/jobs_c4">
              Jobs
            </a>
          </li>
          <li>
            <a className="" rel="" data-aut-id="" href="/mobile-phones_c1453">
              Mobile Phones
            </a>
          </li>
        </ul>
      ...
      <section className="">
        ...
        <ul>
          <li>
            <a className="" rel="" data-aut-id="" href="/motorcycles_c81">
              Bikes
            </a>
          </li>
          <li>
            <a className="" rel="" data-aut-id="" href="/watches_c1970">
              Watches
            </a>
          </li>
          <li>
            <a className="" rel="" data-aut-id="" href="/items/q-books">
              Books
            </a>
          </li>
          <li>
            <a className="" rel="" data-aut-id="" href="/items/q-dogs">
              Dogs
            </a>
          </li>
        </ul>
      ...
      <section className="">
        ...
        <ul>
          ...
          <li>
            <a className="" rel="" data-aut-id="" href="/sitemap/most-popular">
              Sitemap
            </a>
          </li>
          <li>
      ...
      <div className="">
        <a
          ...
          data-aut-id=""
        >
          <span className="" role="listbox" tabindex="0" id="" data-aut-id="">
            <svg
              width="48px"
              height="48px"
              viewBox="0 0 1024 1024"
              ...
              fill-rule="evenodd"
            >
              <path className="rui-77aaa" d=""></path>
            </svg>
          </span>
        </a>
        <a
        ...
        >
          <span className="" role="listbox" tabindex="0" id="" data-aut-id="">
            <svg width="48px" height="48px" viewBox="069 93.312-90.069z">
              <path className="rui-77aaa" d=""></path>
            </svg>
          </span>{" "}
        </a>
